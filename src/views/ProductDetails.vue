      ...
      <div class="row">
        <div class="col-md-5">
          <div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <a class="carousel-control-next" href="#carouselExampleIndicatiors" role="button" data-bs-slide="next">
          ...
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <p class="card-text pb-3">
                배송비
                <!--{{ getCurrencyFormat(productDetail.delivery_price) }}-->원 | 도서산간(제주도) 배송비 추가
                <!--{{ getCurrencyFormat(productDetail.add_delivery_price) }}-->원 | 택배배송 |
